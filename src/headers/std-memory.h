...
#define mem_calloc(a, b) _mem_calloc($$A (a), (b), __LINE__, __FILE__)
#define mem_alloc(size) _mem_alloc($$A (size), __LINE__, __FILE__)
#define mem_free(size) _mem_free($$A (size), __LINE__, __FILE__)
